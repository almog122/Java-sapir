...
public class Assignment9 {
	...
	public static void main(String[] args) {
		//This program gets arrays from user and uses the functions on the entered array.
		//The first function check if the array is ascending/descending and return true if the condition met or falsh if not.
		...
		//the fifth function return the highest sum of prime numbers in a row of an array.
		...
		System.out.print("{"); //Print the array , in a form like {a,b,c}
		for(i = 0; i < array.length; i++)
		{
		...
		System.out.print("arrayDivide1 :"); //Print the array , in a form like {a,b,c}
		System.out.print(" {");
		for(i = 0; i < arrayDivide1.length; i++)
		{
		...
		System.out.println("sumPrime array :"); //Print the array , in a form like {a,b,c}
		System.out.print(" {");
		for(i = 0; i < sumPrime.length; i++)
		{
			for(j = 0; j < sumPrime[i].length; j++)
